 ...
 * Use the [RecipeNutritionFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class RecipeNutritionFragment : Fragment() {
    ...
    companion object {
        ...
        fun newInstance(param1: String, param2: String) =
            RecipeNutritionFragment().apply {
                arguments = Bundle().apply {
                    putString(ARG_PARAM1, param1)
                    putString(ARG_PARAM2, param2)
                }
            }
        fun newInstance() = RecipeNutritionFragment()
    }
}